...
public:
    ...
    [[nodiscard]] const torch::Tensor& true_rank() const;
    [[nodiscard]] const torch::Tensor& true_guess() const;
    [[nodiscard]] const torch::Tensor& true_score() const;
    ...
    [[nodiscard]] const torch::Tensor& success() const;
    [[nodiscard]] const torch::Tensor& best_channel() const;
    [[nodiscard]] const torch::Tensor& best_sample() const;
...
private:
    torch::Tensor true_rank_;
    torch::Tensor true_guess_;
    torch::Tensor true_score_;
    torch::Tensor top1_guess_;
    torch::Tensor top2_guess_;
    torch::Tensor score_gap_;
    torch::Tensor success_;
    torch::Tensor best_channel_;
    torch::Tensor best_sample_;
