...
inline constexpr auto plugin_name = "leakflow_plugins_crypto";
...
// Register the crypto payload codecs (CorrelationPayload, CorrelationPoiPayload) for
// BufferFileSink/Src -- so an expensive correlation can be saved and reloaded to
// re-select PoIs offline.
