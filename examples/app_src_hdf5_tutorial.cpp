...
//
// Usage:
//   leakflow_app_src_hdf5_tutorial [--graph] [ROOT_DIR]
    ...
    try {
        ...
        for (int index = 1; index < argc; ++index) {
            ...
            if (arg == "--graph") {
                ...
                std::cout << "usage: leakflow_app_src_hdf5_tutorial [--graph] [--auto-start]\n"
        ...
        std::cerr << "leakflow_app_src_hdf5_tutorial: " << error.what() << "\n";
        return 1;
    }
}
