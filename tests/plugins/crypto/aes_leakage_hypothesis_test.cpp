...
int main() {
  ...
  hypothesis.set_property("units", leakflow::Units::of({0, 2}));
  ...
  combined_hypothesis.set_property("units", leakflow::Units::of({1}));
  ...
  direct_hypothesis.set_property("units", leakflow::Units::of({0}));
